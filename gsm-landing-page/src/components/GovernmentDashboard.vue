      ...
      <div class="header-content">
        <div class="header-left">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h1 class="text-xl font-bold text-white header-title">地理信息安全监测平台</h1>
              <p class="text-xs text-slate-400 header-subtitle">Geospatial Security Monitoring Platform</p>
            </div>
          </div>
        </div>
